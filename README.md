...
- [x] **URL pública del blog o entrada:** (https://github.com/contentweb10-del/mi-blog-tecnico/blob/main/README.md)
...
- [x] **Documentación clara y estructurada según plantilla
- [x] **Evidencia de control de versiones
